...
{
    public static readonly Dictionary<string, uint> Vehicles = new( )
    {
        ...
        // Tuners Update
        { "calico", 0xB8D657AD }, //Karin Calico GTF
        { "comet6", 0x991EFC04 }, //Pfister Comet S2
        { "dominator7", 0x196F9418 }, //Vapid Dominator ASP
        { "dominator8", 0x2BE8B90A }, //Vapid Dominator GTT
        { "euros", 0x7980BDD5 }, //Annis Euros
        { "futo2", 0xA6297CC8 }, //Karin Futo GTX
        { "growler", 0x4DC079D7 }, //Pfister Growler
        { "jester4", 0xA1B3A871 }, //Dinka Jester RR
        { "previon", 0x546DA331 }, //Karin Previon
        { "remus", 0x5216AD5E }, //Annis Remus
        { "rt3000", 0xE505CF99 }, //Dinka RT3000
        { "sultan3", 0xEEA75E63 }, //Karin Sultan RS Classic
        { "tailgater2", 0xB5D306A4 }, //Obey Tailgater S
        { "vectre", 0xA42FC3A5 }, //Emperor Vectre
        { "warrener2", 0x2290C50A }, //Vulcan Warrener HKR
        { "zr350", 0x91373058 }, //Annis ZR350
        ...
        //addition of missing vehicles 09.01.2022
        { "cypher", 0x68A5D1EF }, //Cypher
        { "entity2", 0x8198AEDC }, //Entity XXR
        { "formula", 0x1446590A }, //PR4
        { "formula2", 0x8B213907 }, //R88
        { "furia", 0x3944D5A0 }, //Furia
        { "jb7002", 0x177DA45C }, //JB 700W
        { "kamacho", 0xF8C2E0E7 }, //Kamacho
        { "minitank", 0xB53C6C52 }, //Invade and Persuade Tank
        { "taipan", 0xBC5DC07E }, //Taipan
        { "tyrant", 0xE99011C2 }, //Tyrant
        { "vetir", 0x780FFBD2 }, //Vetir
        { "weevil", 0x61FE4D6A }, //Weevil
    ...
    {
        var matches = Vehicles.Where( v => v.Key.Contains( vehicleName ) ).ToList( );

        return matches.Count > 0;
    }

    public static bool Exists( uint model )
    {
        var matches = Vehicles.Where( v => v.Value == model ).ToList( );

        return matches.Count > 0;
    }

    public static uint GetVehicleModelByName( string vehicleName )
    {
        var matches = Vehicles.Where( v => v.Key.Contains( vehicleName ) ).ToList( );
